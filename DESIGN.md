...
Patrones que salieron de las rondas de mockups de **Arqueos** y de **Iniciar sesión / Solicitar acceso** (explorados como Artifacts, todavía no implementados en código). Cada uno quedó resuelto a nivel de diseño — esta sección es la especificación para cuando se construyan.
